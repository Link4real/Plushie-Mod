...
public class TurtlePlushieBlock extends PlushieBlock {
    public TurtlePlushieBlock(Properties properties) {
        super(properties);
    }
    ...
    public @NotNull VoxelShape getShape(BlockState state, BlockGetter p_220053_2_, BlockPos p_220053_3_, CollisionContext p_220053_4_) {
        ...
        return switch (dir) {
            case NORTH, SOUTH -> Shapes.box(0.05f, 0f, 0f, 0.95f, 0.4f, 1f);
            case EAST, WEST -> Shapes.box(0f, 0f, 0.05f, 1f, 0.4f, 0.95f);
