...
public class CowPlushieBlock extends PlushieBlock {
    ...
    public CowPlushieBlock(Properties properties) {
        super(properties);
    }
    ...
    public @NotNull VoxelShape getShape(BlockState state, BlockGetter p_220053_2_, BlockPos p_220053_3_, CollisionContext p_220053_4_) {
        ...
        return switch (dir) {
            case NORTH, SOUTH -> Shapes.box(0.25f, 0f, 0.125f, 0.75f, 0.85f, 0.875f);
            case EAST, WEST -> Shapes.box(0.125f, 0f, 0.25f, 0.875f, 0.85f, 0.75f);
