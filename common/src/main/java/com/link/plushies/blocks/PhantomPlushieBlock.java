...
public class PhantomPlushieBlock extends PlushieBlock {
    ...
    public @NotNull VoxelShape getShape(BlockState state, BlockGetter p_220053_2_, BlockPos p_220053_3_, CollisionContext p_220053_4_) {
        ...
        return switch (dir) {
            case EAST, WEST -> Shapes.box(0.2f, 0f, 0f, 0.8f, 0.2f, 1f);
            case NORTH, SOUTH -> Shapes.box(0f, 0f, 0.2f, 1f, 0.2f, 0.8f);
