...
public class Items {
    ...
    private static final RegistrySupplier<Item> ZOMBIEFIED_PIGLIN = ITEMS.register("zombiefied_piglin_plushie", () -> new BlockItem(Blocks.ZOMPIGLIN_BLOCK.get(), props.rarity(Rarity.UNCOMMON)));
