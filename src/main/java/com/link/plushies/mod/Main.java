...
public class Main implements ModInitializer {
    ...
    public static ItemGroup ITEM_GROUP = Registry.register(Registries.ITEM_GROUP, new Identifier(MOD_ID, "main"),
            FabricItemGroup.builder().displayName(Text.literal("Plushie Mod")).icon(() -> new ItemStack(ModBlocks.PANDA_PLUSHIE)).entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.HORSE_PLUSHIE);
